...
module.exports = {
	...
	'build:editor-css': [ require( './build/editor-css' ) ],
	'build:deprecated-css': [ require( './build/deprecated-css' ) ],
	...
	'build:blocks': [ require( './build/blocks' ) ],
	'build:scripts': [ require( './build/scripts' ) ],
