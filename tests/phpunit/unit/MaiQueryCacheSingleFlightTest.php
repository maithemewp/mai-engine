...
final class MaiQueryCacheSingleFlightTest extends TestCase {
	...
	public function test_single_flight_on_with_persistent_object_cache(): void {
		...
		$this->assertTrue( $this->call( new Mai_Query_Cache(), 'use_single_flight' ) );
	}
	...
	public function test_wait_for_fill_returns_value_once_fresh(): void {
		...
		$out = $this->call( new Mai_Query_Cache(), 'wait_for_fill', $cache, 'k', 'v' );
	...
	public function test_wait_for_fill_times_out_to_null(): void {
		...
		$this->assertNull( $this->call( new Mai_Query_Cache(), 'wait_for_fill', $cache, 'k', 'v' ) );
	}
	...
	public function test_serve_sets_found_pages_and_preserves_order(): void {
		...
		$posts = $this->call( new Mai_Query_Cache(), 'serve', $query, [ 'ids' => [ 7, 5, 6 ], 'found' => 53 ] );
