/**
 * Add header tracker element with JS.
 *
 * @type {Element}
 */
var siteHeader = document.getElementsByClassName( 'site-header' )[ 0 ];
var headerTrackerSpan = document.createElement( 'span' );
headerTrackerSpan.setAttribute( 'id', 'header-tracker' );

siteHeader.parentNode.insertBefore( headerTrackerSpan, siteHeader );
