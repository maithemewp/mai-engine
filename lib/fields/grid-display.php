...
function mai_get_grid_display_fields() {
	...
	$fields    = [
		...
		[
			'key'               => 'mai_grid_block_custom_content_2',
			'name'              => 'custom_content_2',
			'label'             => esc_html__( 'Custom Content 2', 'mai-engine' ),
			'type'              => 'textarea',
			'default_value'     => $defaults['custom_content_2'],
			'rows'              => 3,
			'conditional_logic' => [
				[
					'field'    => 'mai_grid_block_show',
