...
add_action( 'genesis_onboarding_before_import_content', 'mai_backup_featured_images' );
/**
 ...
 * @return void
 */
function mai_backup_featured_images() {
...
add_action( 'genesis_onboarding_after_import_content', 'mai_delete_image_backup', 98 );
/**
 ...
 * @return void
 */
function mai_delete_image_backup() {
	$content = genesis_onboarding_config()['content'];
	$temp    = get_stylesheet_directory() . '/assets/temp/';
...
add_action( 'genesis_onboarding_after_import_content', 'mai_update_thumbnail_ids', 99 );
/**
 ...
 * @return void
 */
function mai_update_thumbnail_ids() {
	$posts = get_posts(
		[
			'numberposts' => -1,
			'post_type'   => 'any',
...
add_action( 'genesis_onboarding_after_import_content', 'mai_set_permalink_structure', 100 );
/**
 ...
 * @return void
 */
function mai_set_permalink_structure() {
	global $wp_rewrite;
