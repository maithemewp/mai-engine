...
add_action( 'acf/init', 'mai_register_term_grid_block' );
/**
 * Register Mai Term Grid block.
 *
 * @since 0.1.0
 ...
 * @return void
 */
function mai_register_term_grid_block() {
	register_block_type( __DIR__ . '/term-block.json',
		[
